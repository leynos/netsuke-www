...
| Netsuke provides a friendly, localizable, accessible CLI. | Home page terminal section; docs page; install and guides pages. | `Aligned` | The CLI design document and roadmap explicitly prioritise friendliness, Fluent localization, accessibility, progress reporting, and clear diagnostics. |
